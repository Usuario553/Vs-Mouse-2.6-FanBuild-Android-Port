...
function onCreate()
	...
	makeLuaSprite('main', 'Stages/clubhouse-main', -350, -150);
	addLuaSprite('main',false)
        setLuaSpriteScrollFactor('main', 1, 1);

	makeLuaSprite('smol', 'Stages/clubhouse-smol', -350, -150);
	addLuaSprite('smol',false)
        setLuaSpriteScrollFactor('smol', 1, 1);

	makeLuaSprite('house', 'Stages/clubhouse-house', -350, -150);
	addLuaSprite('house',false)
        setLuaSpriteScrollFactor('house', 1, 1);

	makeLuaSprite('idk', 'Stages/clubhouse-idk', -350, -150);
	...
	makeLuaSprite('head', 'Stages/clubhouse-markus-head', -300, 350);
	addLuaSprite('head',false)
        scaleObject('head', 0.4, 0.4);
        setLuaSpriteScrollFactor('head', 1, 1);

makeLuaSprite('Start', 'loading/clubhouse-beta', 0, 0);
