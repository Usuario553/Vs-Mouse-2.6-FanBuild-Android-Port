...
function onCreate()
	...
	makeLuaSprite('character-prep', 'Stages/abd', -350, -150);
	addLuaSprite('character-prep',false)
        scaleObject('character-prep', 0.76, 0.76);
        setLuaSpriteScrollFactor('character-prep', 1, 1);
