function onCreate()
	if dadName == 'black' then
		makeAnimatedLuaSprite('animatedicon', 'icons/bf2Icons1', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'ManifestNormalIcon', 25, true)
		addAnimationByPrefix('animatedicon', 'losing', 'ManifestNormalIcon', 25, true)
